...
def plot_summary_table(eval_results, selected, model_params, output_path):
    ...
    table_data = [
        ...
        ['', ''],
        ['收益率统计', ''],
        ['未套保收益率均值', f'{metrics["mean_unhedged"]:.6f}'],
        ['套保后收益率均值', f'{metrics["mean_hedged"]:.6f}'],
        ['未套保收益率标准差', f'{metrics["std_unhedged"]:.6f}'],
        ['套保后收益率标准差', f'{metrics["std_hedged"]:.6f}'],
        ['', ''],
        ['风险指标', ''],
        ['未套保夏普比率', f'{metrics["sharpe_unhedged"]:.4f}'],
        ['套保后夏普比率', f'{metrics["sharpe_hedged"]:.4f}'],
        ['未套保最大回撤', f'{metrics["max_dd_unhedged"]:.2%}'],
        ['套保后最大回撤', f'{metrics["max_dd_hedged"]:.2%}'],
        ['', ''],
        ['风险价值', ''],
        ['未套保 VaR(95%)', f'{metrics["var_95_unhedged"]:.6f}'],
        ['套保后 VaR(95%)', f'{metrics["var_95_hedged"]:.6f}'],
        ['未套保 CVaR(95%)', f'{metrics["cvar_95_unhedged"]:.6f}'],
        ['套保后 CVaR(95%)', f'{metrics["cvar_95_hedged"]:.6f}'],
    ]
...
<body>
    <div class="container">
        ...
        <div class="metric">
            <div class="metric-title">套保后夏普比率</div>
        ...
        <h2>📋 完整指标表</h2>
        <table>
            <tr><th>指标</th><th>未套保</th><th>套保后</th></tr>
